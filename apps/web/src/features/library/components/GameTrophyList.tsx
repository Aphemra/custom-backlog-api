    ...
    return (
      <li className="game-trophy game-trophy--locked game-trophy--concealed">
        <button
          ...
          onClick={onReveal}
        >
          <div className="game-trophy__icon" aria-hidden="true">
            <span>?</span>
          </div>
          ...
          <div className="game-trophy__content">
            <div className="game-trophy__heading">
              ...
              <div className="game-trophy__badges">
                <span className="game-trophy__secret">Secret</span>
              </div>
            </div>
    ...
    >
      ...
      <div className="game-trophy__content">
        <div className="game-trophy__heading">
          ...
          <div className="game-trophy__badges">
            <span className={`trophy-grade trophy-grade--${trophy.trophyType}`}>
              {trophy.trophyType}
            </span>
              ...
              {visibleGroups.length === 0 ? (
                ...
                <div className="game-trophy-groups" aria-live="polite">
                  {visibleGroups.map((group) => (
                    ...
                    >
                      <div className="game-trophy-group__heading">
                        <h4>{group.name}</h4>
